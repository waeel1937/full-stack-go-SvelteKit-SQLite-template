...
const file_proto_health_proto_rawDesc = "" +
	"\n" +
	"\x12proto/health.proto\x12\x06health\"\a\n" +
	"\x05Empty\"\x1e\n" +
	"\x06Status\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value20\n" +
	"\x06Health\x12&\n" +
	"\x05Check\x12\r.health.Empty\x1a\x0e.health.StatusB\x15Z\x13backend/proto;protob\x06proto3"
...
var file_proto_health_proto_goTypes = []any{
	(*Empty)(nil),  // 0: health.Empty
	(*Status)(nil), // 1: health.Status
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: health.Health.Check:input_type -> health.Empty
	1, // 1: health.Health.Check:output_type -> health.Status
