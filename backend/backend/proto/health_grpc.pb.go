...
type HealthClient interface {
	Check(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *healthClient) Check(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Status, error) {
...
type HealthServer interface {
	Check(context.Context, *Empty) (*Status, error)
...
func (UnimplementedHealthServer) Check(context.Context, *Empty) (*Status, error) {
